...
template<typename MPM_ITEMS>
bool mpm::SubMeshMpm<MPM_ITEMS>::isParticleIncluded(ParticleSoilPtr pPtr) {
    bool status = 0;
...
template<typename MPM_ITEMS>
void mpm::SubMeshMpm<MPM_ITEMS>::setParticle(ParticleSoilPtr pPtr) {
    unsigned elementId;
...
template<typename MPM_ITEMS>
bool mpm::SubMeshMpm<MPM_ITEMS>::addParticleToSubMesh(ParticleSoilPtr pPtr) {
    bool status = 0;
