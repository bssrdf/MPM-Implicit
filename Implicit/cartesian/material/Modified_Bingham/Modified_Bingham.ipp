...
void mpm::material::Modified_Bingham::computeStress(const Vec6x1_& F, double& P, Vec6x1_& S, const ParticleCloudSoilPtr pCloudSoilPtr, const unsigned id) {
...
void mpm::material::Modified_Bingham::computeStress3D(const Vec6x1_& F, double& P, Vec6x1_& S, const ParticleCloudSoilPtr pCloudSoilPtr, const unsigned id) {
